...
export class AdminPanelComponent {
  ...
  //templates of categories and users only for testing and making szpadel w chuja 
  users = new Array<User>

  categories = new Array<string>

  constructor() {
    this.users = [new User('Adam_wymiatacz', false), new User('Monika69', false), new User('Łowca-okazji', false)]
